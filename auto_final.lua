...
-- == AUTH SYSTEM ==
local auth = {
    KEYS_URL   = "https://raw.githubusercontent.com/Nhanz9999/System-Key/refs/heads/main/Key-Samp",
    STATUS_URL = "https://raw.githubusercontent.com/Nhanz9999/System-Key/refs/heads/main/Status-Samp",
    ROUTES_URL = "https://raw.githubusercontent.com/Nhanz9999/System-Key/refs/heads/main/text.txt",
    authenticated  = false,
    systemEnabled  = true,
...
local intro = {
    ...
    startTime   = 0,
    textLines   = {
        {text="Script Auto Truck-Nhanz", alpha=0},
        {text="Get Key Ib Zalo",          alpha=0},
        {text="0356423176",               alpha=0},
    },
    imageAlpha = 0,
...
imgui.OnFrame(function()
    ...
    if imgui.Begin("Auto Truck", show_window, flags) then
        ...
        imgui.Text(u8("Auto Truck - Nhanz"))
        imgui.Separator()
...
imgui.OnInitialize(function()
    ...
    local logo_path = getWorkingDirectory() .. "/resource/nhanz.png"
